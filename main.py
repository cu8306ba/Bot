...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            ...
            msg = 'Bienvenido a TgUploader en su versión 1.15.0!\n\n'
            ...
            #    bot_token = '5302581657:AAFsPWg5z12RJCtspldCsyF7nFXudFK-rrw'
...
def main():
    ...
    #set in debug
    bot_token = '5383826507:AAHQZrNtmyyTNGMVFBZsJnvJxgnQWchPPSQ'
